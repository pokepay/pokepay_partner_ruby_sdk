...
response = $client.send(Pokepay::Request::GetCpmToken.new(
                          "UmVf4VyeCq2zv3m8EEJTte"                              # cpm_token: CPMトークン
))
```
...
response = $client.send(Pokepay::Request::ListTransactions.new(
                          from: "2021-09-29T20:07:24.000000+09:00",             # 開始日時
                          to: "2022-07-31T09:19:31.000000+09:00",               # 終了日時
                          page: 1,                                              # ページ番号
...
response = $client.send(Pokepay::Request::CreateTransaction.new(
                          ...
                          money_amount: 3731,
                          point_amount: 5598,
                          point_expires_at: "2021-11-27T04:38:36.000000+09:00", # ポイント有効期限
                          description: "PAKZKPgTBuuzmE82FXQId8b7y1pRWueZ0KeUazMXVvOufuSQG5JXrcr1smXBGt9nL7odm1v5XmnnOoYTpQrqT1a8MpDWEaz1NRm7Qy2OfT4tQ4wMMqx0TYiqaWFOsINpkgU9aUzWMEiLDgKu4zT64GL"
))
```
...
response = $client.send(Pokepay::Request::ListTransactionsV2.new(
                          ...
                          customer_name: "太郎",                                  # エンドユーザー名
                          description: "店頭QRコードによる支払い",                         # 取引説明文
                          transaction_id: "lkk",                                # 取引ID
                          is_modified: true,                                    # キャンセルフラグ
                          types: ["topup", "payment"],                          # 取引種別 (複数指定可)、チャージ=topup、支払い=payment
                          from: "2022-11-06T12:32:28.000000+09:00",             # 開始日時
                          to: "2023-12-08T03:48:03.000000+09:00",               # 終了日時
...
response = $client.send(Pokepay::Request::CreateTopupTransaction.new(
                          ...
                          money_amount: 6307,                                   # マネー額
                          point_amount: 4625,                                   # ポイント額
                          point_expires_at: "2022-01-13T12:41:13.000000+09:00", # ポイント有効期限
...
response = $client.send(Pokepay::Request::CreateCpmTransaction.new(
                          "2lUDdOmpyVlJwONKN8r89J",                             # cpm_token: CPMトークン
                          "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx",               # shop_id: 店舗ID
                          5044.0,                                               # amount: 取引金額
...
response = $client.send(Pokepay::Request::RefundTransaction.new(
                          ...
                          returning_point_expires_at: "2020-09-08T12:37:29.000000+09:00" # 返却ポイントの有効期限
))
```
...
response = $client.send(Pokepay::Request::GetAccountTransferSummary.new(
                          ...
                          from: "2020-08-09T03:12:12.000000+09:00",             # 集計期間の開始時刻
                          to: "2021-05-15T21:34:21.000000+09:00",               # 集計期間の終了時刻
...
response = $client.send(Pokepay::Request::ListTransfers.new(
                          from: "2020-02-09T19:11:46.000000+09:00",
                          to: "2023-01-05T15:11:50.000000+09:00",
                          page: 4727,
                          per_page: 3317,
                          shop_id: "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx",
                          shop_name: "soAm4jxkZlaPGnC9YJFp6p0zRrU0lCGV3Uq4HmqHawkKDCgeNO0rz37QmQFa7JuoJnfFva5D9Js4SpYvByeGqsj0yprdNuvsMiTo9p1rwmLYQgKrtUqWoWK0KcKtpTqPN7myg36HD5i4ElkfXmuJ8hE57Gl7pEKHMZEnnv4BGWcXxjyI99p2wwdsD9Wwjus0ApwAwAgwMCGaWRsSg3h5K009IFGAIBrQxpHcGKfPvcPcqXe2SirdO",
                          customer_id: "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx",
                          customer_name: "tGUCiEWdi1Ff7oXyWoC9O9Pn9Tk0RmbpiLPAWvGb3gNC5gax3jFqG34TeAGBm",
                          transaction_id: "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx",
                          private_money_id: "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx",
                          is_modified: true,
                          transaction_types: ["transfer", "exchange", "topup"],
                          transfer_types: ["campaign", "topup", "cashback", "expire", "transfer", "payment"], # 取引明細の種類でフィルターします。
...
response = $client.send(Pokepay::Request::ListTransfersV2.new(
                          shop_id: "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx",      # 店舗ID
                          shop_name: "3oML201Kv2jLgbkZm0a57cp58WtFAPm2CMCqD092jwL0eHU1A8A1kyz6GCuc2lkvjquuHwsnis8AhNg2Gh4IFi7DXKWH4BW1Bt3mcnIH8T37b4Z6gJVJM5Ba9YAtMNgIiSGs7TzdlFwscEaew2dWWpFcOiWlMfDgcxcJlxLoaQoRA96dZ6S1icruAvDLWQ2gFnyZbfK59ElGkmtszNollZKDY7qfTgVdofpEuLyi3S", # 店舗名
                          customer_id: "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx",  # エンドユーザーID
                          customer_name: "nm5oHDwZj9wr0rxbCTZFMBhgbDB47qUAIYBi5IMIf83o46tM1uAXbWimqAE3Dcc4WGt00szKRkD20l5WdYc73FGvp3SuLO0AlqFo3zVjnggRNklsd4R6uLyF9dFCg2T4e8RjF5SFckQVVFd3yTTxaSCfqju2Vf0EwqEH7TlYEtkNJVErHp1jWI2d28DyMO1Lr4TCCyhNf", # エンドユーザー名
                          ...
                          per_page: 50,                                         # 1ページ分の取引数
                          transfer_types: ["cashback", "exchange", "expire", "payment", "campaign", "transfer", "topup"], # 取引明細種別 (複数指定可)
                          description: "店頭QRコードによる支払い",                         # 取引詳細説明文
                          from: "2020-12-16T19:38:30.000000+09:00",             # 開始日時
                          to: "2023-05-24T17:22:04.000000+09:00"                # 終了日時
))
```
...
response = $client.send(Pokepay::Request::CreateCheck.new(
                          ...
                          money_amount: 9513.0,                                 # 付与マネー額
                          point_amount: 2321.0,                                 # 付与ポイント額
                          description: "test check",                            # 説明文(アプリ上で取引の説明文として表示される)
                          is_onetime: true,                                     # ワンタイムかどうかのフラグ
                          usage_limit: 3782,                                    # ワンタイムでない場合の最大読み取り回数
                          expires_at: "2023-07-23T19:54:14.000000+09:00",       # チャージQRコード自体の失効日時
                          point_expires_at: "2021-04-12T01:29:02.000000+09:00", # チャージQRコードによって付与されるポイント残高の有効期限
...
response = $client.send(Pokepay::Request::ListChecks.new(
                          ...
                          private_money_id: "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx", # マネーID
                          organization_code: "u1E1meAhuITUibwYMGbQVn",          # 組織コード
                          expires_from: "2022-08-28T09:15:07.000000+09:00",     # 有効期限の期間によるフィルター(開始時点)
                          expires_to: "2020-09-30T16:26:24.000000+09:00",       # 有効期限の期間によるフィルター(終了時点)
                          created_from: "2020-02-14T13:42:25.000000+09:00",     # 作成日時の期間によるフィルター(開始時点)
                          created_to: "2023-07-16T08:43:58.000000+09:00",       # 作成日時の期間によるフィルター(終了時点)
                          issuer_shop_id: "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx", # 発行店舗ID
                          description: "tkB",                                   # チャージQRコードの説明文
...
response = $client.send(Pokepay::Request::UpdateCheck.new(
                          "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx",               # check_id: チャージQRコードのID
                          money_amount: 8755.0,                                 # 付与マネー額
                          point_amount: 805.0,                                  # 付与ポイント額
                          description: "test check",                            # チャージQRコードの説明文
                          is_onetime: false,                                    # ワンタイムかどうかのフラグ
                          usage_limit: 1178,                                    # ワンタイムでない場合の最大読み取り回数
                          expires_at: "2021-01-01T10:44:21.000000+09:00",       # チャージQRコード自体の失効日時
                          point_expires_at: "2022-07-15T22:32:53.000000+09:00", # チャージQRコードによって付与されるポイント残高の有効期限
                          point_expires_in_days: 60,                            # チャージQRコードによって付与されるポイント残高の有効期限(相対日数指定)
                          bear_point_account: "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx", # ポイント額を負担する店舗のウォレットID
...
response = $client.send(Pokepay::Request::ListBills.new(
                          page: 6232,                                           # ページ番号
                          per_page: 8581,                                       # 1ページの表示数
                          bill_id: "hfs",                                       # 支払いQRコードのID
                          private_money_id: "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx", # マネーID
                          organization_code: "6l-Hmh--5p6G5--o",                # 組織コード
                          description: "test bill",                             # 取引説明文
                          created_from: "2021-03-23T09:09:17.000000+09:00",     # 作成日時(起点)
                          created_to: "2022-08-19T18:05:45.000000+09:00",       # 作成日時(終点)
                          shop_name: "bill test shop1",                         # 店舗名
                          shop_id: "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx",      # 店舗ID
                          lower_limit_amount: 854,                              # 金額の範囲によるフィルタ(下限)
                          upper_limit_amount: 9666,                             # 金額の範囲によるフィルタ(上限)
...
response = $client.send(Pokepay::Request::ListAccountBalances.new(
                          "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx",               # account_id: ウォレットID
                          page: 3655,                                           # ページ番号
                          per_page: 5197,                                       # 1ページ分の取引数
                          expires_at_from: "2021-01-03T20:07:24.000000+09:00",  # 有効期限の期間によるフィルター(開始時点)
                          expires_at_to: "2020-09-23T20:16:10.000000+09:00",    # 有効期限の期間によるフィルター(終了時点)
...
response = $client.send(Pokepay::Request::ListAccountExpiredBalances.new(
                          ...
                          expires_at_from: "2023-08-14T13:13:56.000000+09:00",  # 有効期限の期間によるフィルター(開始時点)
                          expires_at_to: "2020-04-01T17:53:50.000000+09:00",    # 有効期限の期間によるフィルター(終了時点)
                          direction: "asc"                                      # 有効期限によるソート順序
))
```
...
response = $client.send(Pokepay::Request::UpdateCustomerAccount.new(
                          ...
                          account_name: "KZUbuF5frlZI2NZV29i8v7j7bvyomB8OIGyNSRTGERCKmoynLLrH1BhaZ0yGuTDU9xHE6jN2ds6rwpMAz5TtRgFrJwfWjNO3YVGvyPy89d81CTxzIK9IZjcAcLLK627tMRzqFgh4D92lCwnLTeBkWgb", # アカウント名
                          external_id: "7z6eouBuuJDsl864jIsQXxH5r1wTUoJhlOdEA5MpQnTAd3RErW", # 外部ID
...
response = $client.send(Pokepay::Request::GetCustomerAccounts.new(
                          "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx",               # private_money_id: マネーID
                          page: 2588,                                           # ページ番号
                          per_page: 3803,                                       # 1ページ分のウォレット数
                          created_at_from: "2020-02-08T16:35:04.000000+09:00",  # ウォレット作成日によるフィルター(開始時点)
                          created_at_to: "2022-12-07T10:20:45.000000+09:00",    # ウォレット作成日によるフィルター(終了時点)
                          is_suspended: true,                                   # ウォレットが凍結状態かどうかでフィルターする
                          status: "pre-closed",                                 # ウォレット状態
                          external_id: "WQSuEQMZ2d4ctRFBEsxS",                  # 外部ID
                          tel: "08871-6857",                                    # エンドユーザーの電話番号
                          email: "7Et3QEIBWJ@HiAX.com"                          # エンドユーザーのメールアドレス
))
```
...
response = $client.send(Pokepay::Request::CreateCustomerAccount.new(
                          ...
                          external_id: "B5RBXuqhLNzG5FyaZFb4QsFOFE"             # 外部ID
))
```
...
response = $client.send(Pokepay::Request::GetShopAccounts.new(
                          "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx",               # private_money_id: マネーID
                          page: 1527,                                           # ページ番号
                          per_page: 3178,                                       # 1ページ分のウォレット数
                          created_at_from: "2020-06-01T00:01:22.000000+09:00",  # ウォレット作成日によるフィルター(開始時点)
                          created_at_to: "2022-08-23T04:02:57.000000+09:00",    # ウォレット作成日によるフィルター(終了時点)
                          is_suspended: true                                    # ウォレットが凍結状態かどうかでフィルターする
))
```
...
response = $client.send(Pokepay::Request::ListCustomerTransactions.new(
                          ...
                          from: "2021-08-02T02:16:12.000000+09:00",             # 開始日時
                          to: "2020-05-24T22:28:17.000000+09:00",               # 終了日時
                          page: 1,                                              # ページ番号
                          per_page: 50                                          # 1ページ分の取引数
))
```
...
response = $client.send(Pokepay::Request::ListShops.new(
                          ...
                          private_money_id: "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx", # マネーID
                          name: "oxスーパー三田店",                                    # 店舗名
                          postal_code: "310-6441",                              # 店舗の郵便番号
                          address: "東京都港区芝...",                                 # 店舗の住所
                          tel: "053-2911470",                                   # 店舗の電話番号
                          email: "1qE4IXda2y@DCFz.com",                         # 店舗のメールアドレス
                          external_id: "QLM0pdp1q56CWM6IAAL",                   # 店舗の外部ID
...
response = $client.send(Pokepay::Request::CreateShop.new(
                          ...
                          shop_postal_code: "296-9568",                         # 店舗の郵便番号
                          shop_address: "東京都港区芝...",                            # 店舗の住所
                          shop_tel: "096555283",                                # 店舗の電話番号
                          shop_email: "grLxd7FC8w@UgOD.com",                    # 店舗のメールアドレス
                          shop_external_id: "mGgU1WM37Qqg84w36G5cZnhZse",       # 店舗の外部ID
...
response = $client.send(Pokepay::Request::CreateShopV2.new(
                          "oxスーパー三田店",                                          # name: 店舗名
                          postal_code: "353-0612",                              # 店舗の郵便番号
                          address: "東京都港区芝...",                                 # 店舗の住所
                          tel: "075-23-6612",                                   # 店舗の電話番号
                          email: "sXJ4mLp8H2@b5MH.com",                         # 店舗のメールアドレス
                          external_id: "kA1odlhZiu",                            # 店舗の外部ID
                          organization_code: "ox-supermarket",                  # 組織コード
...
response = $client.send(Pokepay::Request::UpdateShop.new(
                          "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx",               # shop_id: 店舗ユーザーID
                          name: "oxスーパー三田店",                                    # 店舗名
                          postal_code: "1258318",                               # 店舗の郵便番号
                          address: "東京都港区芝...",                                 # 店舗の住所
                          tel: "0630240-204",                                   # 店舗の電話番号
                          email: "qoYVVQx50I@FGzR.com",                         # 店舗のメールアドレス
                          external_id: "deJJpQwCts10453OAEWV9",                 # 店舗の外部ID
                          private_money_ids: ["xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx"], # 店舗で有効にするマネーIDの配列
...
response = $client.send(Pokepay::Request::CreateUserAccount.new(
                          "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx",               # user_id: ユーザーID
                          "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx",               # private_money_id: マネーID
                          name: "vBuqTkRboiUVKEn0OURqamF84TTDaByynyI6fIPPcUVohGc3OEyLHWszUiXXJUJoWxVjWJS3Y3B69YYpq22tRojr73gPwyZw0n5lmGxqkkvVUc2tW4ZMGoXGJmU8TkUnRMOOGG0WE8aDekdgbqbr2qn8vVm2Z7M8ID6oODu9tHg5NpVQk6bDP2LO", # ウォレット名
                          external_id: "VzxHMnHjwcDnT69haofPuOF8KjpGrZ5YbRFhbfQbsE1Kdvc2L", # 外部ID
                          metadata: "{\"key1\":\"foo\",\"key2\":\"bar\"}"       # ウォレットに付加するメタデータ
))
```
...
response = $client.send(Pokepay::Request::GetPrivateMoneyOrganizationSummaries.new(
                          "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx",               # private_money_id: マネーID
                          from: "2023-12-12T01:42:33.000000+09:00",             # 開始日時(toと同時に指定する必要有)
                          to: "2020-10-20T21:12:08.000000+09:00",               # 終了日時(fromと同時に指定する必要有)
                          page: 1,                                              # ページ番号
                          per_page: 50                                          # 1ページ分の取引数
))
```
...
response = $client.send(Pokepay::Request::GetPrivateMoneySummary.new(
                          "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx",               # private_money_id: マネーID
                          from: "2023-10-29T23:28:05.000000+09:00",             # 開始日時
                          to: "2023-05-27T14:29:54.000000+09:00"                # 終了日時
))
```
...
response = $client.send(Pokepay::Request::BulkCreateTransaction.new(
                          "PMe0Zgoi937cJ",                                      # name: 一括取引タスク名
                          "1dBSjWbVE",                                          # content: 取引する情報のCSV
                          "mSJwGtjUQP6566g9TvkGukHlKZZ4EGLPvECr",               # request_id: リクエストID
                          description: "299HSNWbn21hO5KIunjWUkVWdyRILT6MPfEoK2cUPQxx7VRd4fgJWST2Tz8KGf2St3IixzrdHyJfApOG2yGQ4mLROfQRvGk4TyNugQTAkCRi8ai5BFvq", # 一括取引の説明
                          private_money_id: "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx" # マネーID
))
```
...
response = $client.send(Pokepay::Request::CreateCampaign.new(
                          "oBVoOGaBQRJV0sBboiNPCOPZs0ge7h0sPgNnrw77bHQUTKY5GkH0XDwnHyLzQtcAMSIUsHkb7zCYqkQqdSbQVH8OPJDGXVBln63FKkFUwYWlrX0iZscKzczP1s1Rbv6IgvVmSfzRew6hS9i5GlQeIloESZCGqVaCcir8RD", # name: キャンペーン名
                          "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx",               # private_money_id: マネーID
                          "2023-10-07T16:46:37.000000+09:00",                   # starts_at: キャンペーン開始日時
                          "2023-05-04T22:56:14.000000+09:00",                   # ends_at: キャンペーン終了日時
                          6197,                                                 # priority: キャンペーンの適用優先度
                          "topup",                                              # event: イベント種別
                          bear_point_shop_id: "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx", # ポイント負担先店舗ID
                          description: "f0KJeJnXQHIxfEZIezNLmcU1ctYZzBfiYnY7jG5USKpDnQnzITu0a1pdvGz2ra4HYXKJOsRaDmx", # キャンペーンの説明文
                          status: "enabled",                                    # キャンペーン作成時の状態
                          point_expires_at: "2022-08-08T10:22:31.000000+09:00", # ポイント有効期限(絶対日時指定)
                          point_expires_in_days: 1527,                          # ポイント有効期限(相対日数指定)
  ...
  "to": "23:59"
                          ...
                          minimum_number_for_combination_purchase: 5637,        # 複数種類の商品を同時購入するときの商品種別数の下限
                          exist_in_each_product_groups: false,                  # 複数の商品グループにつき1種類以上の商品購入によって発火するキャンペーンの指定フラグ
                          max_point_amount: 4967,                               # キャンペーンによって付与されるポイントの上限
                          max_total_point_amount: 9046,                         # キャンペーンによって付与されるの1人当たりの累計ポイントの上限
  ...
  "value": "male"
                          ...
                          budget_caps_amount: 836007810                         # キャンペーン予算上限
))
```
...
response = $client.send(Pokepay::Request::ListCampaigns.new(
                          ...
                          available_from: "2020-05-04T15:32:54.000000+09:00",   # 指定された日時以降に適用可能期間が含まれているか
                          available_to: "2021-09-13T09:01:05.000000+09:00",     # 指定された日時以前に適用可能期間が含まれているか
                          page: 1,                                              # ページ番号
...
response = $client.send(Pokepay::Request::UpdateCampaign.new(
                          "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx",               # campaign_id: キャンペーンID
                          name: "jvrKcJyJNCCuLUxFHZfefjQUi2brCVWuCFIAUugojhMZC4gPnIAwBnGeCYrCCq8wGjIMmljsMB7FrBNoEuKPOBjA6cZewDZpKd82viMmzTAsd3FUYO2VChazQj70BjfXkVfdwZ6y0WjcqdHP9GkeiolbYxOenGcdxMqprbMsWv8ifOcslj9BIq4K8VuPuwgTP82hCWOHqgFtD3dX5rTR6GPR", # キャンペーン名
                          starts_at: "2022-08-06T17:43:58.000000+09:00",        # キャンペーン開始日時
                          ends_at: "2021-08-12T22:45:26.000000+09:00",          # キャンペーン終了日時
                          priority: 6540,                                       # キャンペーンの適用優先度
                          event: "topup",                                       # イベント種別
                          description: "OhI6tfs0OyNeObwMCchJguWnsoaS4F57Vz1JBUXM19OC1ugh2tmTHMCRtv8TW9jfh9kXB9ay3PtML5ps7nqbvxQ5hWPIGUa666v6PDiyew1nSRQmtIuxMDzPDs75LzPCLVhELKuWPcXmoWD39zgUQGlulUVJRZjcwkExeE94lL", # キャンペーンの説明文
                          status: "disabled",                                   # キャンペーン作成時の状態
                          point_expires_at: "2020-05-20T10:05:48.000000+09:00", # ポイント有効期限(絶対日時指定)
                          point_expires_in_days: 961,                           # ポイント有効期限(相対日数指定)
  ...
  "to": "23:59"
                          ...
                          minimum_number_for_combination_purchase: 4611,        # 複数種類の商品を同時購入するときの商品種別数の下限
                          exist_in_each_product_groups: false,                  # 複数の商品グループにつき1種類以上の商品購入によって発火するキャンペーンの指定フラグ
                          max_point_amount: 9943,                               # キャンペーンによって付与されるポイントの上限
                          max_total_point_amount: 7544,                         # キャンペーンによって付与されるの1人当たりの累計ポイントの上限
                          applicable_account_metadata: {
  "key": "sex",
  "value": "male"
},                                                                              # ウォレットに紐付くメタデータが特定の値を持つときにのみ発火するキャンペーンを登録します。
                          budget_caps_amount: 1937014523                        # キャンペーン予算上限
))
```
...
response = $client.send(Pokepay::Request::ListCoupons.new(
                          ...
                          coupon_id: "dlN9Amj",                                 # クーポンID
                          coupon_name: "lk2guzhUR",                             # クーポン名
                          issued_shop_name: "iPZE",                             # 発行店舗名
                          available_shop_name: "5gV81lBiu",                     # 利用可能店舗名
                          available_from: "2021-02-16T13:52:36.000000+09:00",   # 利用可能期間 (開始日時)
                          available_to: "2020-10-23T15:28:12.000000+09:00",     # 利用可能期間 (終了日時)
                          page: 1,                                              # ページ番号
                          per_page: 50                                          # 1ページ分の取得数
))
```
...
response = $client.send(Pokepay::Request::CreateCoupon.new(
                          "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx",
                          "CS6kt5JyzEEFGhm1Gf5Jb9FZyAK2mS9XZpjRwsQoyC2Q9L9sgl3XuvvIzU",
                          "2022-08-05T11:41:50.000000+09:00",
                          "2022-05-11T11:48:59.000000+09:00",
                          "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx",               # issued_shop_id: 発行元の店舗ID
                          description: "xDbC2xGL5j7kJZLjvlZRTaAbBa13shWzdQDj9EsovFNkNFoVbF4jbiKxL8aTm2q6zMvVJuLwQOo9PzRjscidav3XHODZ8KAsv32Erc0BzMSguuB84OvpcPXRAguQJTWx2LRFuAvyfnjA8GizhqwfCquI8VWefcGgPbz17k",
                          discount_amount: 4569,
                          discount_percentage: 7468.0,
                          discount_upper_limit: 7183,
                          display_starts_at: "2023-03-22T07:36:38.000000+09:00", # クーポンの掲載期間(開始日時)
                          display_ends_at: "2022-03-30T10:20:17.000000+09:00",  # クーポンの掲載期間(終了日時)
                          is_disabled: false,                                   # 無効化フラグ
                          is_hidden: true,                                      # クーポン一覧に掲載されるかどうか
                          is_public: false,                                     # アプリ配信なしで受け取れるかどうか
                          code: "5RVkM28",                                      # クーポン受け取りコード
                          usage_limit: 3831,                                    # ユーザごとの利用可能回数(NULLの場合は無制限)
                          min_amount: 7584,                                     # クーポン適用可能な最小取引額
...
response = $client.send(Pokepay::Request::UpdateCoupon.new(
                          "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx",               # coupon_id: クーポンID
                          name: "zYtHHktaTNPyMYkQst",
                          description: "k0WOoeLhnWyGQjT7xKs0isZCM0Fi5pNCaACWO7vVddQbVvj0E1pnlcIRoAe9US2oeUP2zz58riAzy2eLyDa1veWrdHf6rMUUKGQYZ2GKIMcCqQdlPxOOQPgSLZ1hL1HCidrMLSsuPHPP4hA77z3kEqEEqKnEOn6pWR",
                          discount_amount: 1475,
                          discount_percentage: 8281.0,
                          discount_upper_limit: 6553,
                          starts_at: "2022-01-27T07:55:44.000000+09:00",
                          ends_at: "2022-06-12T21:19:07.000000+09:00",
                          display_starts_at: "2023-03-12T12:05:25.000000+09:00", # クーポンの掲載期間(開始日時)
                          display_ends_at: "2020-03-25T21:13:12.000000+09:00",  # クーポンの掲載期間(終了日時)
                          is_disabled: true,                                    # 無効化フラグ
                          is_hidden: true,                                      # クーポン一覧に掲載されるかどうか
                          is_public: false,                                     # アプリ配信なしで受け取れるかどうか
                          code: "Dw",                                           # クーポン受け取りコード
                          usage_limit: 2369,                                    # ユーザごとの利用可能回数(NULLの場合は無制限)
                          min_amount: 2151,                                     # クーポン適用可能な最小取引額
                          is_shop_specified: true,                              # 特定店舗限定のクーポンかどうか
...
response = $client.send(Pokepay::Request::CreateBank.new(
                          ...
                          email: "HGsoATpkoz@CWNP.com",                         # ユーザーのメールアドレス
