...
response = $client.send(Pokepay::Request::BulkCreateTransaction.new(
                          "aTF42abkgSmtE",                                      # name: 一括取引タスク名
                          "HAWzKVmw",                                           # content: 取引する情報のCSV
                          "mqN4ax1Q1Fha0o1JxRbdO7sJMkOiIt9zNKCX",               # request_id: リクエストID
                          description: "VzisXLLiEpULitiIsW57odiOHhS8DsZfAQRFK6oTTeP8tTTuI", # 一括取引の説明
