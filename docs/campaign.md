...
response = $client.send(Pokepay::Request::CreateCampaign.new(
                          "rFxY0nh8lQ2iQavwvhDr8TNB4vIcRTpSaCV5lZtxsN8hQh23jWL68GyttBaIaA6bT2oimSP8aDw1fwYQo1a8Jvio1NlXmWokT3fCZ0aqdulZZGglvs1mmHvcGJdXuMvjofsG8E4KIFxs3y0EBuTM1S0iPJraQIMtAPJ1JN9CtWW30Uo4UAg9arJ4XCMrwN15cI", # name: キャンペーン名
                          "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx",               # private_money_id: マネーID
                          "2023-06-03T21:51:52.000000Z",                        # starts_at: キャンペーン開始日時
                          "2021-05-14T13:06:38.000000Z",                        # ends_at: キャンペーン終了日時
                          5088,                                                 # priority: キャンペーンの適用優先度
                          "topup",                                              # event: イベント種別
